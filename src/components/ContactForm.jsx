            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className="flex flex-wrap -mx-2">
                <div className="w-full md:w-1/2 px-2 mb-4">
                  <ComponentInput
                    className={`form-control w-full p-3 border rounded-lg focus:outline-none ${errors.name ? 'border-red-500' : formData.name ? 'border-green-500' : 'border-blue-300'
                      }`}
                    name="name"
                    id="name"
                    type="text"
                ...
                <div className="w-full px-2 mb-4">
                  <ComponentInput
                    className={`form-control w-full p-3 border rounded-lg focus:outline-none ${errors.subject ? 'border-red-500' : formData.subject ? 'border-green-500' : 'border-blue-300'
                      }`}
                    name="subject"
                    id="subject"
                    type="text"
