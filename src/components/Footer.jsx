...
import { faEnvelope, faGlobe, faLocationDot, faPhone, faUserGraduate } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left'>
                    ...
                    <div className='mb-8 md:col-span-2 lg:col-span-1 flex flex-col items-center md:items-start'>
                        <a href='/' className='text-white font-bold text-xl flex items-center'>
                            <FontAwesomeIcon className='text-white-700 mr-1' icon={faGlobe} /> JJ Website Service Solution
                        </a>
